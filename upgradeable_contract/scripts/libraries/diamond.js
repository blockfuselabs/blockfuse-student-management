...
function getSelectors(contractOrInterface) {
  // Accepts either a contract instance (with .interface) or an interface directly
  const iface = contractOrInterface.interface
    ? contractOrInterface.interface
    : contractOrInterface;
