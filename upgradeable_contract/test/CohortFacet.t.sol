...
contract CohortFacetTest is Test, IDiamondCut {
    ...
    function testTrackManagement() public {
        ...
        (, string[] memory trackNames,,,,, address[][] memory studentsByTrack) =
    ...
    function testCohortRetrieval() public {
        ...
        (uint256 id1,,, uint256 retrievedStartDate1, uint256 retrievedEndDate1, uint256 duration1,) =
            CohortFacet(address(diamond)).getCohort(2);
        ...
        (uint256 id2,,, uint256 retrievedStartDate2, uint256 retrievedEndDate2, uint256 duration2,) =
    ...
    function testStudentEnrollmentIntegration() public {
        ...
        (, string[] memory trackNames, uint256 totalStudents,,,, address[][] memory studentsByTrack) =
            CohortFacet(address(diamond)).getCohort(cohortId);
        ...
        (, string[] memory emptyTrackNames, uint256 emptyTotalStudents,,,, address[][] memory emptyStudentsByTrack) =
