...
contract StudentFacetTest is Test, IDiamondCut {
    ...
    function testLogAttendanceByStudent() public {
        ...
        bool hasAttended = StudentFacet(address(diamond)).hasAttendance(student1, cohortId, web2Track, block.timestamp / 1 days);
    ...
    function testLogAttendanceAccessControl() public {
        ...
        assertTrue(StudentFacet(address(diamond)).hasAttendance(student1, cohortId, web2Track, (block.timestamp - 1 days) / 1 days));
        assertTrue(StudentFacet(address(diamond)).hasAttendance(student1, cohortId, web2Track, block.timestamp / 1 days));
    }
